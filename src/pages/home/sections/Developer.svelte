<script>
  //   import { circleOne, circleTwo, circleThree } from "../assets/researchData";
...
<TwoCol>
  <span slot="text">
    <h2>A Developer</h2>
    <p>
      I can help you develop a software project with a reliable and expandable
      codebase. I have experience in front end web development, database design,
      api design, and more.
    </p>
  </span>
